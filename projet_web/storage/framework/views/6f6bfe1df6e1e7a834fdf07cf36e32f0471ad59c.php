    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                <h1 class="mbr-section-title align-center pb-3 mbr-fonts-style display-2">Liste des évènements</h1>
                <h2 class="mbr-section-title align-center pb-3 mbr-fonts-style display-2">Retrouvez ici les évènements passés et à venir!</h2>
            </div>
        </div>
    </div>
</section>
...
<section>
    <div class="container-fluid border border-warning rounded mb-0">
		...
		<img src="/media/examples/grapefruit-slice-332-332.jpg" alt="image de présentation de l'évènement" />
		<div class="jaime">    

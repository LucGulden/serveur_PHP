...
<footer class="page-footer font-small indigo" style="margin-top: 30px; background-color: #e3f2fd; background: linear-gradient(#4E4E4E, #000000);">
    ...
    <!-- Copyright -->
    <div class="footer-copyright text-center py-3">© CESI 2019 - <a href="/mentions_legales">Mentions Légales </a> - <a href="/ConditionV">Conditions de Ventes</a> - <a href="/ConditionsG">Les Conditions du règlement</a>
    </div>
    <!-- Copyright -->
